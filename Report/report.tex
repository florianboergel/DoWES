...
\end{align*}
It can be seen, that for conditions below rated wind speed it is still possible to achieve a high power coefficient. The calculated power coefficient for 8 m/s is 0.544. If the wind speed is higher than the rated wind speed the power coefficient drops significantly. This is due to the limited power generation of the generator. Not all kinetic energy of the wind can be transformed into electrical energy and pitching is required to protect the generator. 
