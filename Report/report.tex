...
\subsection{Damage equivalent loads under free stream}
...
\begin{tabular}{| c | c | c |}
\hline
\textbf{sensor} & \textbf{max} & \textbf{min} \\
\hline
Tower side-to-side & $5419.259$ & $775.607$  \\
\hline
Tower fore-aft & $6328.944$ & $2382.669$	\\
\hline
Blade edgewise & $2560.151$ & $1923.647$ 	\\
\hline
Blade flapwise & $2353.317$ & $738.816$ 	\\
\hline
\end{tabular}
...
For all of the four sensors the max and min values always come from the same of the three settings meaning that in that setting there is a high span betwenn the $5m/s$ DEL and the $25m/s$ DEL. For instance the tower side-to-side max and min DEL values both come from wake conditions with $4\cdot d$ distance while for the tower fore-aft DEL the extreme values come from free stream conditions.
