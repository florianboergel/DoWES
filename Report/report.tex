...
\subsection{Task d}
The Campbell diagram is depicted in Figure~\ref{fig:campbell}. The red line shows the computed Eigenfrequency of the tower and the circles mark resonance cases for certain rotor speed values. For example the dashed blue line ($1\Omega$) represents the unbalance, the second blue line ($3\Omega$) etc.\\

The operational range of the rotor with respect to tower Eigenfrequencies must thus be kept within the limits between the last ($\Omega$ with red line) and the second-last point of intersection ($3\Omega$ with red line).
