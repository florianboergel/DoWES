--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
Blue turbine FAST input file. LVT July 2014
...
9628.253    VS_RtTq     - Rated generator torque/constant generator torque in Region 3 for simple variable-speed generator control (HSS side) (N-m) [used only when VSContrl=1]
...
---------------------- TURBINE CONFIGURATION -----------------------------------
  46.00     TipRad      - The distance from the rotor apex to the blade tip (meters)
...
"Blue_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"Blue_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"Blue_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"Blue_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"Blue_turbine_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
