--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
Green turbine FAST input file. LVT July 2014
...
8573.777     VS_RtTq     - Rated generator torque/constant generator torque in Region 3 for simple variable-speed generator control (HSS side) (N-m) [used only when VSContrl=1]
...
---------------------- TURBINE CONFIGURATION -----------------------------------
  41.00     TipRad      - The distance from the rotor apex to the blade tip (meters)
...
---------------------- MASS AND INERTIA ----------------------------------------
 ...
 125.000E3  NacMass     - Nacelle mass (kg)
...
"Green_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"Green_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"Green_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"Green_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"Green_turbine_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
