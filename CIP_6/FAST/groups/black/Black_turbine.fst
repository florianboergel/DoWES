--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
Black turbine FAST input file. LVT July 2014
...
---------------------- TURBINE CONFIGURATION -----------------------------------
  62.00     TipRad      - The distance from the rotor apex to the blade tip (meters)
 ...
 115.00     TowerHt     - Height of tower above ground level [onshore] or MSL [offshore] (meters)
...
"Black_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"Black_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"Black_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"Black_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"Black_turbine_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
