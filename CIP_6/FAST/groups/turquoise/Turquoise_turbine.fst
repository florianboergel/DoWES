--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
Turquoise turbine FAST input file. LVT July 2014
...
18410.41    VS_RtTq     - Rated generator torque/constant generator torque in Region 3 for simple variable-speed generator control (HSS side) (N-m) [used only when VSContrl=1]
   0.005682 VS_Rgn2K    - Generator torque constant in Region 2 for simple variable-speed generator control (HSS side) (N-m/rpm^2) [used only when VSContrl=1]
...
---------------------- TURBINE CONFIGURATION -----------------------------------
  60.00     TipRad      - The distance from the rotor apex to the blade tip (meters)
...
"Turquoise_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"Turquoise_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"Turquoise_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"Turquoise_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"Turquoise_turbine_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
