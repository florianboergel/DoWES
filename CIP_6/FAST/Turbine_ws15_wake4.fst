...
9999.9      TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
   ...
   30.0      BlPitchF(1) - Blade 1 final pitch for pitch maneuvers (degrees)
   30.0     BlPitchF(2) - Blade 2 final pitch for pitch maneuvers (degrees)
   30.0     BlPitchF(3) - Blade 3 final pitch for pitch maneuvers (degrees) [unused for 2 blades]
...
---------------------- INITIAL CONDITIONS --------------------------------------
  ...
  12.59     RotSpeed    - Initial or fixed rotor speed (rpm)
   0.0      NacYaw      - Initial or fixed nacelle-yaw angle (degrees)
   0.0      TTDspFA     - Initial fore-aft tower-top displacement (meters)
   0.0      TTDspSS     - Initial side-to-side tower-top displacement (meters)
---------------------- TURBINE CONFIGURATION -----------------------------------
  54.002      TipRad      - The distance from the rotor apex to the blade tip (meters)
...
---------------------- AERODYN -------------------------------------------------
"Turbine_AD_wake4_ws15.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
