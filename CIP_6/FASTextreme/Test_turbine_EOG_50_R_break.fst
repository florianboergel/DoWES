--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
Test file with data from WindPACT 1.5 MW turbine. LVT July 2014
...
210.0       TimGenOf    - Time to turn off the generator (s) [used only when GenTiStp=True]
   1        HSSBrMode   - HSS brake model {1: simple, 2: user-defined from routine UserHSSBr} (switch)
210.5       THSSBrDp    - Time to initiate deployment of the HSS brake (s)
...
12000.24     HSSBrTqF    - Fully deployed HSS-brake torque (N-m)
 150.5      HSSBrDT     - Time for HSS-brake to reach full deployment once initiated (sec) [used only when HSSBrMode=1]
...
"Turbine_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"Turbine_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"Turbine_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"Turbine_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"Test_turbine_AD_EOG_50_R.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
...
"ES10.3E2"  OutFmt      - Format used for tabular output except time.  Resulting field should be 10 characters. (quoted string)  [not checked for validity!]
 150.0      TStart      - Time to begin tabular output (s)
