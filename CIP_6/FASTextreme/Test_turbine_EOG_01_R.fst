...
9214.24     HSSBrTqF    - Fully deployed HSS-brake torque (N-m)
 212.5      HSSBrDT     - Time for HSS-brake to reach full deployment once initiated (sec) [used only when HSSBrMode=1]
...
---------------------- AERODYN -------------------------------------------------
"Test_turbine_AD_EOG_01_R.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
